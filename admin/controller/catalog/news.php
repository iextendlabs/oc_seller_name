...
class ControllerCatalogNews extends Controller {
	...
	protected function getList() {
		...
		$data['sort_title'] = $this->url->link('catalog/news', 'user_token=' . $this->session->data['user_token'] . '&sort=title' . $url, true);
	...
	protected function getForm() {
		...
		if (isset($this->request->post['meta_title'])) {
			...
			$data['meta_title'] = $news_info['meta_title'];
		} else {
			$data['meta_title'] = '';
		}
		...
		if (isset($this->request->post['meta_description'])) {
			...
			$data['meta_description'] = $news_info['meta_description'];
		} else {
		...
		if (isset($this->request->post['meta_keyword'])) {
			...
			$data['meta_keyword'] = $news_info['meta_keyword'];
		} else {
			$data['meta_keyword'] = '';
		}
