...
class ControllerCatalogProduct extends Controller {
	...
	protected function getList() {
		...
		$data['sort_model'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=p.model' . $url, true);
				...
				$data['sort_seller_id'] = $this->url->link('catalog/product', 'user_token=' . $this->session->data['user_token'] . '&sort=ps.seller_id' . $url, true);
		...
		$data['order'] = $order;
				...
				$data['sellers'] = $this->model_extension_module_seller->getSellerForProduct();
		...
		if (isset($this->request->post['model'])) {
			...
			$data['model'] = '';
				...
				if (isset($this->request->post['seller_name'])) {
					...
					$data['seller_name'] = $product_info['seller_name'];
				} else {
					$data['seller_name'] = '';
				}
